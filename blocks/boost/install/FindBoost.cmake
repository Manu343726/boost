...
function(_Boost_GUESS_COMPILER_PREFIX _ret)
  if(Boost_DEBUG)
    message(STATUS "_Boost_GUESS_COMPILER_PREFIX on ${CMAKE_CXX_COMPILER_ID}")
  endif()

  if(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
    execute_process(COMMAND ${CMAKE_CXX_COMPILER} --version OUTPUT_VARIABLE out)
    string(REGEX REPLACE ".*clang version ([0-9]+)\\.([0-9]+).*" "\\1\\2" _boost_COMPILER_VERSION "${out}") 
    set(_boost_COMPILER "-clang${_boost_COMPILER_VERSION}")

    if(Boost_DEBUG)
      message(STATUS "EXPERIMENTAL: Clang compiler. _boost_COMPILER = ${_boost_COMPILER}")
    endif()
